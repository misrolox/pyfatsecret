...
Module 'foods.py' contains the following methods:
    ...
    - https://platform.fatsecret.com/docs/v1/foods.autocomplete
    ...
    - https://platform.fatsecret.com/docs/v2/foods.search
    ...
    - https://platform.fatsecret.com/docs/v2/food.get
    - https://platform.fatsecret.com/docs/v1/food.get
    - https://platform.fatsecret.com/docs/v2/food_brands.get
    - https://platform.fatsecret.com/docs/v1/food_brands.get
    - https://platform.fatsecret.com/docs/v2/food_categories.get
    - https://platform.fatsecret.com/docs/v1/food_categories.get
    - https://platform.fatsecret.com/docs/v2/food_sub_categories.get
    - https://platform.fatsecret.com/docs/v1/food_sub_categories.get
...
class Foods(FatsecretBase):
    ...
    def foods_autocomplete_v2(self, expression, max_results=None, region=None) -> dict:
        """
        ...
        """
        params = self.get_params(expression=expression,
                                 max_results=max_results, region=region)

        return self.make_request(method='foods.autocomplete.v2', params=params)

    def foods_autocomplete(self, expression, max_results=None, region=None) -> dict:
        """
        Returns food elements best matching the search expression specified, ordered by their relevancy to the search expression.
        An interactive demonstration of our Autocomplete API can be accessed here
        Note: foods.autocomplete only works for the default region / language combination.
        ...
        Returns:
            dict: See https://platform.fatsecret.com/docs/v1/foods.autocomplete
        """
        params = self.get_params(expression=expression,
                                 max_results=max_results, region=region)

        return self.make_request(method='foods.autocomplete', params=params)

    def food_find_id_for_barcode_v2(self, barcode, include_sub_categories=None, include_food_images=None, include_food_attributes=None, flag_default_serving=None, region=None, language=None) -> dict:
        """
        ...
        Returns:
            dict: See https://platform.fatsecret.com/docs/v2/food.find_id_for_barcode
        """
        params = self.get_params(barcode=barcode, include_sub_categories=include_sub_categories, include_food_images=include_food_images,
        ...
        return self.make_request(method='food.find_id_for_barcode.v2', params=params)
    ...
    def foods_search_v4(self, search_expression=None, page_number=None, max_results=None, include_sub_categories=None, include_food_images=None, include_food_attributes=None, flag_default_serving=None, region=None, language=None) -> dict:
        """
        ...
        We are introducing version 4 to correspond to an update for the food.get.v5 which includes additional standardized servings for foods where food_type is Brand, and where the existing serving includes a serving amount.
        The additional servings will be either 100 g, 100 ml or 1 oz and 100 g, depending on the existing serving measurement unit, and will always have a serving_id=0
        Note: These new derived servings cannot be used to add to a food entry via food_entry.create.
        ...
        Returns:
            dict: See https://platform.fatsecret.com/docs/v4/foods.search
        """
        ...
        return self.make_request(method='foods.search.v4', params=params)
    ...
    def foods_search_v2(self, search_expression=None, page_number=None, max_results=None, include_sub_categories=None, flag_default_serving=None, region=None, language=None) -> dict:
        """
        Conducts a search of the food database using the search expression specified. The results are paginated according to a zero-based "page" offset. Successive pages of results may be retrieved by specifying a starting page offset value. For instance, specifying a max_results of 10 and page_number of 4 will return results numbered 41-50.
        Returns detailed nutritional information for the specified food. Use this call to display nutrition values for a food to users.
        An interactive demonstration of our Food Search API can be accessed here
        ...
        Returns:
            dict: See https://platform.fatsecret.com/docs/v2/foods.search
        """
        params = self.get_params(search_expression=search_expression, page_number=page_number, max_results=max_results,
                                 include_sub_categories=include_sub_categories, flag_default_serving=flag_default_serving, region=region, language=language)

        return self.make_request(method='foods.search.v2', params=params)
    ...
    def food_get_v5(self, food_id, include_sub_categories=None, include_food_images=None, include_food_attributes=None, flag_default_serving=None, region=None, language=None) -> dict:
        """
        ...
        For foods where food_type is Brand, and where the existing serving includes a serving amount, we now provide additional standardized servings.
        The additional servings will be either 100 g, 100 ml or 1 oz and 100 g, depending on the existing serving measurement unit, and will always have a serving_id=0
        Note: These new derived servings cannot be used to add to a food entry via food_entry.create.
        ...
        Returns:
            dict: See https://platform.fatsecret.com/docs/v5/food.get
        """
        ...
        return self.make_request(method='food.get.v5', params=params)
    ...
    def food_get_v3(self, food_id, include_sub_categories=None, flag_default_serving=None, region=None, language=None) -> dict:
        """
        Returns detailed nutritional information for the specified food for each available standard serving size. Use this call to display nutrition values for a food to users.
        ...
        Returns:
            dict: See https://platform.fatsecret.com/docs/v3/food.get
        """
        params = self.get_params(food_id=food_id, include_sub_categories=include_sub_categories,
                                 flag_default_serving=flag_default_serving, region=region, language=language)

        return self.make_request(method='food.get.v3', params=params)

    def food_get_v2(self, food_id, include_sub_categories=None, flag_default_serving=None, region=None, language=None) -> dict:
        """
        Returns detailed nutritional information for the specified food for each available standard serving size. Use this call to display nutrition values for a food to users.
        ...
        Returns:
            dict: See https://platform.fatsecret.com/docs/v2/food.get
        """
        params = self.get_params(food_id=food_id, include_sub_categories=include_sub_categories,
                                 flag_default_serving=flag_default_serving, region=region, language=language)

        return self.make_request(method='food.get.v2', params=params)

    def food_get(self, food_id, include_sub_categories=None, flag_default_serving=None, region=None, language=None) -> dict:
        """
        Returns detailed nutritional information for the specified food for each available standard serving size. Use this call to display nutrition values for a food to users.
        ...
        Returns:
            dict: See https://platform.fatsecret.com/docs/v1/food.get
        """
        params = self.get_params(food_id=food_id, include_sub_categories=include_sub_categories,
                                 flag_default_serving=flag_default_serving, region=region, language=language)

        return self.make_request(method='food.get', params=params)
    ...
    def food_brands_get(self, starts_with, brand_type=None, region=None, language=None) -> dict:
        """
        This is a utility method, returning the list of food brands.
        ...
        Returns:
            dict: See https://platform.fatsecret.com/docs/v1/food_brands.get
        """
        params = self.get_params(
            starts_with=starts_with, brand_type=brand_type, region=region, language=language)

        return self.make_request(method='food_brands.get', params=params)
    ...
    def food_categories_get(self, region=None, language=None) -> dict:
        """
        This is a utility method, returning the full list of all food categories and their associated unique identifiers.
        ...
        Returns:
            dict: See https://platform.fatsecret.com/docs/v1/food_categories.get
        """
        params = self.get_params(region=region, language=language)

        return self.make_request(method='food_categories.get', params=params)
    ...
    def food_sub_categories_get(self, food_category_id, region=None, language=None) -> dict:
        """
        This is a utility method, returning the full list of all food sub categories for a food category.
        ...
        Returns:
            dict: See https://platform.fatsecret.com/docs/v1/food_sub_categories.get
        """
        params = self.get_params(
            food_category_id=food_category_id, region=region, language=language)

        return self.make_request(method='food_sub_categories.get', params=params)
